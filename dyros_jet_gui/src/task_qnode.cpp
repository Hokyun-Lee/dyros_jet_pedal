...
void TaskQNode::init_nh()
{
  ...
  joy_cmd_publisher_ = nh->advertise<dyros_jet_msgs::WalkingCommand>("/dyros_jet/walking_joy_command", 5);
...
void TaskQNode::send_joy_walk_ctrl()
{
  joy_cmd_publisher_.publish(joy_walk_cmd_msg_);
}
